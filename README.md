...
- Chapter 2 funnel cards show paid-attributed tracked vs inferred counts for each funnel stage, while spend-based KPIs remain blended or tracked-only where ad linkage supports them.
